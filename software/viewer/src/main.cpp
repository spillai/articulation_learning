...
#include <articulation/articulation_renderer.h>
...
//         cmd.state = ERLCM_ROBOT_STATE_ENUM_T_STOP;
...
//         // go into run mode
//         cmd.utime = bot_timestamp_now();
//         cmd.state = ERLCM_ROBOT_STATE_ENUM_T_RUN;
//         cmd.faults = ERLCM_ROBOT_STATUS_T_FAULT_NONE;
...
int main(int argc, char *argv[])
{
    ...
    BotViewer *viewer = bot_viewer_new("FS Viewer");
    ...
    // // setup_renderer_annotation(viewer, 1);
    ...
    // //    kinect_add_skeleton_renderer_to_viewer(viewer, 1, lcm, frames, NULL);
    // //kinect_add_skeleton_renderer_to_viewer(viewer, 0, lcm, frames,"KINECT");//NULL, NULL);
    // setup_renderer_velodyne (viewer, 1, param, lcm);
    // setup_renderer_pcl(viewer,1,param);
    // setup_renderer_topological_graph(viewer,1,param);
    // // setup_renderer_generic_object(viewer,1, param);
    // setup_renderer_manual_calib (viewer, 1);
    // setup_renderer_arm_interface (viewer, 1, lcm, param);
    // //setup_renderer_arm_trace_circle(viewer, 1);
    // setup_renderer_arm_rrts(viewer, 1, param, frames, lcm);
    // add_person_model_renderer_to_viewer(viewer, 1, param, frames, lcm);
    // setup_renderer_nodder(viewer, 0, param, lcm);
    // add_robot_arm_sensor_renderer_to_viewer(viewer, param, 1);
    ...
    articulation_add_renderer_to_viewer(viewer, 1, lcm, frames, "KINECT");
    // Collections renderer
    //collections_add_renderer_to_viewer(viewer, 1);
    // poses_add_renderer_to_viewer(viewer, 1, param);
    ...
    char *fname = g_build_filename (g_get_user_config_dir(), ".fs-viewerrc", 
                                    NULL);
