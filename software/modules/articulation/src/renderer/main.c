...
int main(int argc, char *argv[])
{
    ...
    BotViewer *viewer = bot_viewer_new("Articulation Viewer");
    app.viewer = viewer;
    ...
    articulation_add_renderer_to_viewer(viewer, 0,app.lcm,NULL,NULL);

    // load saved preferences
    char *fname = g_build_filename(g_get_user_config_dir(), ".articulation-viewerrc", NULL);
